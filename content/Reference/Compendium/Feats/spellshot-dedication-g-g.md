...
[archetype](archetype.md "Archetype Feat Trait")  [class](class-som.md "Class Class Trait")  [dedication](dedication.md "Dedication Feat Trait")  [uncommon](uncommon.md "Uncommon Rarity Trait")  
...
**Special.** You can't select another dedication feat other than Beast Gunner Dedication until you've gained two other feats from the [spellshot](Reference/Compendium/Character/Archetypes/spellshot-g-g.md) or [beast gunner](beast-gunner-g-g.md) archetypes.
