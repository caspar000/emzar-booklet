...
[aftermath](aftermath-da.md "Aftermath Class Trait")  [flourish](flourish.md "Flourish Combat Trait")  [magical](magical.md "Magical Item Trait")  [necromancy](necromancy.md "Necromancy School Trait")  [negative](negative.md "Negative Energy & Element Trait")  [rare](rare.md "Rare Rarity Trait")  

- **Prerequisites**: You've been reduced to 0 Hit Points by an enemy with the [negative](negative.md "Negative Energy & Element Trait") trait.
- **Activity** Two-Action
