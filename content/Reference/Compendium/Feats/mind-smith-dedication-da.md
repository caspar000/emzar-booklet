...
- A one-handed weapon that deals `1d4` damage and has the [agile](agile.md "Agile Weapon Trait") and [finesse](finesse.md "Finesse Weapon Trait") traits
- A one-handed weapon that deals `1d6` damage and has the [finesse](finesse.md "Finesse Weapon Trait") trait
- A one-handed weapon that deals `d8` damage
- A two-handed weapon that deals `1d10` damage and has the [reach](reach.md "Reach Weapon Trait") trait
