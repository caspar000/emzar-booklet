...
[cleric](Reference/Rules/Traits/cleric.md "Cleric Class Trait")  [exploration](exploration.md "Exploration Action & Ability Trait")  
...
- **Shield** The shield gains a +1 status bonus to its Hardness. (This causes it to reduce more damage with the [Shield Block](Reference/Compendium/Feats/shield-block.md) reaction.)
