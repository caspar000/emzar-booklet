...
The contest could be a musical battle, a dance-off, an oratorical debate—the two of you could even use entirely different types of performance. The loser of the bout is magically bound to perform a task of the winner's choice within 1 week. The contest consists of taking turns to [Perform](perform.md), starting with your opponent. The [Performance](skills.md#Performance) check's DC is the higher of the opponent's [Perception](skills.md#Perception) DC or Will DC, though the two parties can mutually agree to use an impartial judge instead. The first to reach four successes wins, with each critical successes counting as two successes. If you play the bargainer's instrument as part of your performance, it grants you a +2 item bonus to the [Performance](skills.md#Performance) checks.
