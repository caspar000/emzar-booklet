...
> - **Critical Failure** The target is so afraid it might die. It must attempt a Fortitude save; if the target fails, it dies. On a successful Fortitude save, the target takes `12d6` mental damage, is [fleeing](conditions.md#Fleeing) until the end of its next turn, and is [frightened](conditions.md#Frightened). This effect has the [incapacitation](incapacitation.md "Incapacitation Effect Trait") trait.
