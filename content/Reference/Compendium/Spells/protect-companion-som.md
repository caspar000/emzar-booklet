...
- **Range**: 30 foot
- **Targets**: your eidolon, or a creature with the [minion](minion.md "Minion Creature Trait") trait under your control
- **Duration**: until the start of your next turn

You extend your aura, as a magical shield that protects your eidolon or minion. The target gains a +1 circumstance bonus to AC until the start of your next turn. You gain the following reaction; after using the reaction, the spell ends and you can't cast [protect companion](protect-companion-som.md) again for 10 minutes.
