...
Your insubstantiality is complete enough that you can pass through other creatures, causing painful interference effects when you do so. Once each round when you [Stride](stride.md), [Burrow](burrow.md), [Swim](swim.md), or [Fly](Reference/Rules/Actions/fly.md), you can pass through one creature's space during that action without needing to attempt a check to [Tumble Through](tumble-through.md), though you can't end your turn in its space. When you pass through a creature's space in this way, you deal `2d6` force damage to that creature, with a basic Fortitude save.
