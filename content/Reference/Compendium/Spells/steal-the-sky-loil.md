...
> - **Failure** As success; if the target hits a surface, it falls [prone](conditions.md#Prone) and can't [Fly](Reference/Rules/Actions/fly.md), levitate, or otherwise leave the ground for 1 minute.
