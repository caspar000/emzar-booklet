...
---
# Sunburst *Spell 7*   
[evocation](evocation.md "Evocation School Trait")  [fire](fire.md "Fire Energy & Element Trait")  [light](Reference/Rules/Traits/light.md "Light Effect Trait")  [positive](positive.md "Positive Energy & Element Trait")  
...
> - **Critical Failure** The creature or object takes full damage. If it's a creature, it becomes [blinded](conditions.md#Blinded) permanently. If the globe overlaps with an area of magical darkness, sunburst attempts to counteract the [darkness](Reference/Rules/Traits/darkness.md "Darkness Effect Trait") effect.
