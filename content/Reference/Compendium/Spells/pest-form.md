...
You transform into a the battle form of a Tiny animal, such as a cat, insect, lizard, or rat. You can decide the specific type of animal (such as a rat or praying mantis), but this has no effect on the form's Size or statistics. While in this form, you gain the [animal](animal.md "Animal Creature Type Trait") trait, and you can't make [Strikes](strike.md). You can [Dismiss](dismiss.md) the spell.
