...
[healing](healing.md "Healing Effect Trait")  [necromancy](necromancy.md "Necromancy School Trait")  [positive](positive.md "Positive Energy & Element Trait")  [water](water.md "Water Energy & Element Trait")  
...
A Large creature counts as eight Medium creatures and a Huge creature fills the entire pool. This pool has the [structure](structure.md "Structure General Trait") trait and the same restrictions as magic items that create structures.
