...
A successful [dispel magic](dispel-magic.md) used on a specific effect removes only that effect (such as the [lock](Reference/Compendium/Spells/lock.md) effect on one window). A successful [disjunction](disjunction.md) ends the entire ritual.
