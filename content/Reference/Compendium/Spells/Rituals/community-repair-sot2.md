...
[emotion](emotion.md "Emotion Effect Trait")  [rare](rare.md "Rare Rarity Trait")  [transmutation](transmutation.md "Transmutation School Trait")  
...
- **Range**: 10 feet
- **Targets**: 1 damaged or [broken](conditions.md#Broken) public work no larger than 3,000 cubic feet (the size of a [Huge](huge-b1.md "Huge Size Trait") creature)
