...
- **Domains**: [creation](Reference/Compendium/Setting/domains.md#Creation), [family](Reference/Compendium/Setting/domains.md#Family), [passion](Reference/Compendium/Setting/domains.md#Passion), [protection](Reference/Compendium/Setting/domains.md#Protection)
- **Alternate Domains**: [repose](Reference/Compendium/Setting/domains.md#Repose)
- **Cleric Spells**: 1st: [color spray](color-spray.md); 3rd: [enthrall](enthrall.md); 4th: [creation](creation.md)
...
- **Moderate Boon**: You are inspired to create great works and become a virtuoso at all arts. You gain the [Specialty Crafting](specialty-crafting.md) feat and the [Virtuoso Performer](virtuosic-performer.md) feat in all categories of [Crafting](skills.md#Crafting) and [Performance](skills.md#Performance).
