...
The sorcerer archetype is a method for anyone to pick up commonly useful spells, such as [invisibility](Reference/Compendium/Spells/invisibility.md) and [haste](haste.md).
