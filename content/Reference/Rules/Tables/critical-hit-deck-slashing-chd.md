...
| 9 | **Tangled** _Crit Effect:_ You can attempt to [Grapple](Reference/Rules/Actions/grapple.md) the target as a free action. This uses the same multiple attack penalty as your attack and doesn't count towards your multiple attack penalty. |
...
| 25 | **Hack and Slash** Triple damage. The target is [flat-footed](conditions.md#Flat-footed) until the end of its next turn. |
