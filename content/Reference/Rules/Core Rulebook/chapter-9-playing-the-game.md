...
> 
> All speech has the [auditory](auditory.md "Auditory Effect Trait") trait. If you communicate in some way other than speech, other rules might apply. For instance, using sign language is [visual](visual.md "Visual Effect Trait") instead of [auditory](auditory.md "Auditory Effect Trait").
...
One example of such a reaction is [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md), which fighters gain at 1st level.

This reaction lets you make a melee [Strike](strike.md) if a creature within reach uses a [manipulate](manipulate.md "Manipulate General Trait") or [move](move.md "Move Combat Trait") action, makes a ranged attack, or leaves a square during a [move](move.md "Move Combat Trait") action. The Triggering Moves diagram on page 474 illustrates examples of movements that might trigger an [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md) from a creature without reach and one with reach.
...
Because your [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md) takes place outside of your turn, the attack roll doesn't incur a multiple attack penalty.
...
Each time you are hit by an attack or fail a save on a narrow surface, you must succeed at a Reflex save (with the same DC as the [Acrobatics](skills.md#Acrobatics) check to [Balance](balance.md)) or fall.

#### Uneven Ground
<sup>CRB p. 476</sup>

Uneven ground is an area unsteady enough that you need to [Balance](balance.md) or risk falling prone and possibly injuring yourself, depending on the specifics of the uneven ground. You are [flat-footed](conditions.md#Flat-footed) on uneven ground. Each time you are hit by an attack or fail a save on uneven ground, you must succeed at a Reflex save (with the same DC as the [Acrobatics](skills.md#Acrobatics) check to Balance) or fall prone.

#### Inclines
<sup>CRB p. 476</sup>

An incline is an area so steep that you need to [Climb](climb.md) using the [Athletics](skills.md#Athletics) skill in order to progress upward.
...
To flank a foe, you and your ally must be on opposites sides or corners of the creature. A line drawn between the center of your space and the center of your ally's space must pass through opposite sides or opposite corners of the foe's space. Additionally, both you and the ally have to be able to act, must be wielding melee weapons or able to make an unarmed attack, can't be under any effects that prevent you from attacking, and must have the enemy within reach. If you are wielding a reach weapon, you use your [reach](reach.md "Reach Weapon Trait") with that weapon for this purpose.

### Cover
<sup>CRB p. 477</sup>

When you're behind an obstacle that could block weapons, guard you against explosions, and make you harder to detect, you're behind cover. Standard cover gives you a +2 circumstance bonus to AC, to Reflex saves against area effects, and to [Stealth](skills.md#Stealth) checks to [Hide](Reference/Rules/Actions/hide.md), [Sneak](sneak.md), or otherwise avoid detection. You can increase this to greater cover using the [Take Cover](take-cover.md) basic action, increasing the circumstance bonus to +4. If cover is especially light, typically when it's provided by a creature, you have lesser cover, which grants a +1 circumstance bonus to AC. A creature with standard cover or greater cover can attempt to use [Stealth](skills.md#Stealth) to [Hide](Reference/Rules/Actions/hide.md), but lesser cover isn't sufficient.
...
> 
> **[Borrow an Arcane Spell](borrow-an-arcane-spell.md):** You use [Arcana](skills.md#Arcana) to prepare a spell from someone else's spellbook (page 241).
> 
> **[Coerce](coerce.md):** You use [Intimidation](skills.md#Intimidation) to threaten a creature so it does what you want (page 247).
> 
> **[Cover Tracks](cover-tracks.md):** You use [Survival](skills.md#Survival) to obscure your passing (page 252).
> 
> **[Decipher Writing](decipher-writing.md):** You use a suitable skill to understand archaic, esoteric, or obscure texts (page 234).
> 
> **[Gather Information](gather-information.md):** You use [Diplomacy](skills.md#Diplomacy) to canvass the area to learn about a specific individual or topic (page 246).
> 
...
> 
> **[Impersonate](impersonate.md):** You use [Deception](skills.md#Deception) and usually a disguise kit to create a disguise (page 245).
> 
...
> 
> **[Make an Impression](make-an-impression.md):** You use [Diplomacy](skills.md#Diplomacy) to make a good impression on someone (page 246).
> 
> **[Repair](repair.md):** With a repair kit and the [Crafting](skills.md#Crafting) skill, you fix a damaged item (page 243).
> 
> **[Sense Direction](sense-direction.md):** You use [Survival](skills.md#Survival) to get a sense of where you are or determine the cardinal directions (page 252).
> 
> **[Squeeze](squeeze.md):** Using [Acrobatics](skills.md#Acrobatics), you squeeze though very tight spaces (page 241).
> 
> **[Track](track.md):** You use [Survival](skills.md#Survival) to find and follow creatures' tracks (page 252).
> 
> **[Treat Wounds](treat-wounds.md):** You use [Medicine](skills.md#Medicine) to treat a living creature's wounds (page 249).
...
> 
> **[Craft](craft.md):** Using the [Crafting](skills.md#Crafting) skill, you can create items from raw materials (page 244).
> 
> **[Create Forgery](create-forgery.md):** You forge a document (page 251).
> 
> **[Earn Income](earn-income.md):** You earn money, typically using [Crafting](skills.md#Crafting), Lore, or [Performance](skills.md#Performance) (page 236).
> 
