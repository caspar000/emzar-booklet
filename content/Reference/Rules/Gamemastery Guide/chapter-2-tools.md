...
> 
> **Sniper** high [Perception](skills.md#Perception); high Dex modifier; low Fortitude, high Reflex; moderate to low HP; ranged [Strikes](strike.md) have high attack bonus and damage or moderate attack bonus and extreme damage (melee [Strikes](strike.md) are weaker)
> 
> **Soldier** high Str modifier; high to extreme AC; high Fortitude; high attack bonus and high damage; [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md) or other tactical abilities
> 
...
Choose or design any special senses for your creature, such as [low-light vision](low-light-vision.md), [darkvision](Reference/Rules/Abilities/darkvision.md), or [scent](scent.md). If you're making a sense from scratch, simply decide what it senses, whether it has a range limit, and whether it's precise or imprecise.
...
You can also add special, thematic modifiers for certain skill uses. For instance, you might give a creature that secretes adhesive "[Athletics](skills.md#Athletics) +7 (+9 to [Climb](climb.md) or [Grab](grab.md))." This special bonus should still remain at or below the extreme number, especially if it has a combat purpose like the Grab bonus above.
...
To decide whether your creature should have a reaction, first consider if the creature has the reflexes or insight to react well in the first place—for instance, an ogre doesn't have [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md) because it's a big oaf. Oozes, constructs, and unintelligent creatures are less likely to have reactions than others for this reason.
...
The best reactions should be telegraphed so when they happen, it makes sense to the players. Think of one of the core reactions of the game: [Shield Block](Reference/Compendium/Feats/shield-block.md). The creature raises its shield—an obvious action the PCs can see—so when it blocks damage from an attack, that makes perfect sense.
...
> 
> - **Alchemist** low [Perception](skills.md#Perception); high [Crafting](skills.md#Crafting); high Int, moderate or better Dex or Str; low to moderate HP; moderate attack with bombs; infused alchemical items, Quick Bomber if a bomber alchemist, a few other alchemist abilities; it's usually easier to give the alchemist its bomb items rather than use [Quick Alchemy](Reference/Rules/Actions/quick-alchemy.md) on the spot.
> - **Barbarian** high [Athletics](skills.md#Athletics); high Str, high to moderate Con; high AC; high Fortitude; high HP; moderate attack and extreme damage (when raging); [Rage](Reference/Rules/Actions/rage.md) and a few barbarian abilities
...
> - **Champion** low [Perception](skills.md#Perception); moderate [Religion](skills.md#Religion); high Str or Dex, moderate Cha; extreme AC; low Reflex; moderate attack and high damage; champion's reaction, devotion spells, [Shield Block](Reference/Compendium/Feats/shield-block.md)
...
> - **Cleric (Warpriest)** moderate [Perception](skills.md#Perception); moderate [Religion](skills.md#Religion), moderate or high skill themed to deity; high Str, moderate Wis; high AC; low Reflex, high Will; high spell DC; prepared divine spellcasting as a cleric of their level; divine font, [Shield Block](Reference/Compendium/Feats/shield-block.md)
...
> - **Fighter** high [Acrobatics](skills.md#Acrobatics) or [Athletics](skills.md#Athletics); high Str or Dex; high AC; low Will; high attack and high damage; [Attack of Opportunity](Reference/Rules/Actions/attack-of-opportunity.md), [Shield Block](Reference/Compendium/Feats/shield-block.md), a few fighter abilities
> - **Monk** high [Acrobatics](skills.md#Acrobatics), [Athletics](skills.md#Athletics), or both; high Str or Dex, moderate Wis; high or extreme AC; moderate attack and high damage; [Flurry of Blows](flurry-of-blows.md), a few monk abilities (possibly including ki spells)
> - **Ranger** high [Perception](skills.md#Perception); moderate [Nature](skills.md#Nature) and moderate to high [Survival](skills.md#Survival); high Str or Dex; high AC; moderate attack and high damage (or for a simpler ranger, remove [Hunt Prey](hunt-prey.md) and just use high attack and high damage); a few ranger abilities
...
> 
> - **Alchemist** Feats 1st: [Quick Bomber](quick-bomber.md); 6th: [Debilitating Bomb](debilitating-bomb.md); 8th: [Sticky Bomb](sticky-bomb.md); 10th: [Expanded Splash](expanded-splash.md), [Greater Debilitating Bomb](greater-debilitating-bomb.md); 14th: [True Debilitating Bomb](true-debilitating-bomb.md); 18th: [Miracle Worker](miracle-worker.md)
> - **Barbarian** instinct ability and related feats, raging resistance; Feats 1st: [Raging Intimidation](raging-intimidation.md); 2nd: [No Escape](no-escape.md), [Shake it Off](shake-it-off.md); 4th: [Fast Movement](fast-movement.md), [Swipe (Barbarian)](swipe-barbarian.md); 6th: [Attack of Opportunity (Barbarian)](attack-of-opportunity-barbarian.md), [Cleave](cleave.md); 8th: [Sudden Leap (Barbarian)](sudden-leap-barbarian.md); 10th: [Come and Get Me](come-and-get-me.md), [Knockback](knockback.md), [Terrifying Howl](terrifying-howl.md); 14th: [Awesome Blow](awesome-blow.md), [Whirlwind Strike (Barbarian)](whirlwind-strike-barbarian.md); 18th: [Vicious Evisceration](vicious-evisceration.md)
> - **Bard** muse feats; Feats 4th: [Melodious Spell](melodious-spell.md); 6th: [Dirge of Doom](Reference/Compendium/Feats/dirge-of-doom.md), [Steady Spellcasting (Bard)](steady-spellcasting-bard.md); 10th: [Quickened Casting (Bard)](quickened-casting-bard.md); 14th: [Allegro](Reference/Compendium/Feats/allegro.md), [Soothing Ballad](Reference/Compendium/Feats/soothing-ballad.md); 16th: [Effortless Concentration (Bard)](effortless-concentration-bard.md); 20th: [Fatal Aria](Reference/Compendium/Feats/fatal-aria.md)
> - **Champion** divine ally and related feats, divine smite, exalt, feats based on cause; Feats 1st: [Deity's Domain](deitys-domain.md); 2nd: [Divine Grace](divine-grace.md); 4th: [Aura of Courage](aura-of-courage.md), [Mercy](mercy.md); 6th: [Attack of Opportunity (Champion)](attack-of-opportunity-champion.md); 8th: [Greater Mercy](greater-mercy.md); 12th: [Aura of Faith](aura-of-faith.md); 14th: [Aura of Righteousness](aura-of-righteousness.md), [Divine Reflexes](divine-reflexes.md); 18th: [Celestial Form](celestial-form.md), [Ultimate Mercy](ultimate-mercy.md)
> - **Cleric** Feats 1st: [Harming Hands](harming-hands.md), [Healing Hands](healing-hands.md); 2nd: [Sap Life](sap-life.md), [Turn Undead](turn-undead.md); 4th: [Command Undead](command-undead.md), [Necrotic Infusion](necrotic-infusion.md); 6th: [Divine Weapon](divine-weapon.md), [Selective Energy](selective-energy.md); 8th: [Channeled Succor](channeled-succor.md); 12th: [Defensive Recovery](defensive-recovery.md); 14th: [Fast Channel](fast-channel.md); 16th: [Eternal Bane](eternal-bane.md), [Eternal Blessing](eternal-blessing.md)
> - **Druid** order feats; Feats 6th: [Steady Spellcasting (Druid)](steady-spellcasting-druid.md); 8th: [Fey Caller](fey-caller.md) (only the added spells); 10th: [Overwhelming Energy (Druid)](overwhelming-energy-druid.md); 12th: [Primal Summons](Reference/Compendium/Feats/primal-summons.md); 16th: [Effortless Concentration (Druid)](effortless-concentration-druid.md), 20th: [Leyline Conduit](leyline-conduit.md)
> - **Fighter** bravery, feats associated with a combat style; Feats 1st: [Power Attack](power-attack.md), [Sudden Charge (Fighter)](sudden-charge-fighter.md); 2nd: [Intimidating Strike](intimidating-strike.md), [Lunge](lunge.md); 4th: [Knockdown](Reference/Compendium/Feats/knockdown.md), [Swipe (Fighter)](swipe-fighter.md); 6th: [Shatter Defenses](shatter-defenses.md); 8th: [Blind-Fight (Fighter)](blind-fight-fighter.md), [Felling Strike](felling-strike.md), [Sudden Leap (Fighter)](sudden-leap-fighter.md); 10th: [Certain Strike](certain-strike.md), [Combat Reflexes](combat-reflexes.md), [Disruptive Stance](disruptive-stance.md), [Fearsome Brute](fearsome-brute.md); 12th: [Spring Attack](spring-attack.md); 14th: [Determination](determination.md), [Whirlwind Strike (Fighter)](whirlwind-strike-fighter.md); 20th: [Weapon Supremacy](weapon-supremacy.md)
> - **Monk** metal strikes, mystic strikes, perfected form, stance and related feats; Feats 1st: [Ki Rush](Reference/Compendium/Feats/ki-rush.md), [Ki Strike](Reference/Compendium/Feats/ki-strike.md); 2nd: [Crushing Grab](crushing-grab.md), [Stunning Fist](stunning-fist.md); 4th: [Deflect Arrow](deflect-arrow.md), [Flying Kick](flying-kick.md); 6th: [Abundant Step](Reference/Compendium/Feats/abundant-step.md), [Ki Blast](Reference/Compendium/Feats/ki-blast.md), [Whirling Throw](whirling-throw.md); 8th: [Wall Run](wall-run.md); 10th: [Winding Flow](winding-flow.md); 16th: [Quivering Palm](Reference/Compendium/Feats/quivering-palm.md), [Shattering Strike](shattering-strike.md); 18th: [Diamond Fists](diamond-fists.md), [Swift River](swift-river.md); 20th: [Enduring Quickness](enduring-quickness.md), Impossible Techniques
> - **Ranger** [Hunt Prey](hunt-prey.md), hunter's edge, nature's edge, masterful hunter, swift prey, companion or combat style and related feats; Feats 2nd: [Quick Draw (Ranger)](quick-draw-ranger.md), [Wild Empathy](wild-empathy.md); 4th: Scout's Warning; 6th: Skirmish Strike; 8th: [Blind-Fight (Ranger)](blind-fight-ranger.md), [Warden's Boon](wardens-boon.md); 10th: [Camouflage](camouflage.md); 14th: Sense the Unseen; 18th: [Shadow Hunter](shadow-hunter.md); 20th: [Ultimate Skirmisher](ultimate-skirmisher.md)
> - **Rogue** surprise attack, deny advantage, debilitating strike, master strike, rogue's racket and related feats; Feats 1st: Nimble Dodge; 2nd: [Mobility](mobility.md), [Quick Draw (Rogue)](quick-draw-rogue.md); 4th: Scout's Warning; 6th: [Gang Up](gang-up.md), Skirmish Strike, [Twist the Knife](twist-the-knife.md); 8th: [Blind-Fight (Rogue)](blind-fight-rogue.md), [Opportune Backstab](opportune-backstab.md); 10th: [Sneak Savant](sneak-savant.md); 12th: [Fantastic Leap](fantastic-leap.md), [Spring from the Shadows](spring-from-the-shadows.md); 14th: Sense the Unseen; 16th: [Dispelling Slice](dispelling-slice.md), [Perfect Distraction](perfect-distraction.md); 20th: [Hidden Paragon](hidden-paragon.md), [Reactive Distraction](reactive-distraction.md)
...
> - **Wizard** school and related feats; Feats 1st: [Counterspell (Wizard)](counterspell-wizard.md); 4th: [Bespell Weapon (Wizard)](bespell-weapon-wizard.md); 6th: [Steady Spellcasting (Wizard)](steady-spellcasting-wizard.md); 10th: [Overwhelming Energy (Wizard)](overwhelming-energy-wizard.md), [Quickened Casting (Wizard)](quickened-casting-wizard.md); 12th: [Clever Counterspell](clever-counterspell.md); 14th: [Reflect Spell (Wizard)](reflect-spell-wizard.md); 16th: [Effortless Concentration (Wizard)](effortless-concentration-wizard.md); 18th: [Infinite Possibilities](infinite-possibilities.md); 20th: [Metamagic Mastery (Wizard)](metamagic-mastery-wizard.md), [Spell Combination](spell-combination.md).
...
**Extreme:** While extreme values remain world-class statistics that are extremely difficult to meet or exceed, unlike with monsters, almost all hazards have one extreme statistic because hazards normally activate only if they have gone [unnoticed](conditions.md#Unnoticed) or if someone critically failed to disable them. Does it have an extreme [Stealth](skills.md#Stealth) DC that makes it incredibly hard to find, an extreme Disable DC that makes it perilous to disable, or an extreme save DC that makes it deadly in the event it triggers? These are the most common choices, as each affects a different phase of encountering the hazard.
...
Since they have their own minds, intelligent items might be subject to [mental](mental.md "Mental Effect Trait") effects that require a Will save.
...
Give your item the [artifact](artifact-gmg.md "Artifact Item Trait") trait and either the [rare](rare.md "Rare Rarity Trait") trait (if there multiple items of its kind), or the [unique](unique.md "Unique Rarity Trait") trait (if only one exists). Other traits work like they do for any other item. An artifact is usually 20th level or higher, but its specific level is up to you. Imagine who created it and what their level likely was.
...
Certain drugs alter how addiction works for that drug, adding the [virulent](virulent.md "Virulent Item Trait") trait to the addiction, limiting the maximum stage a character can reach, or adding additional stages beyond those listed in the base affliction.
...
**Shadow:** Planes with this trait are umbral with murky light. On a shadow plane, the radius of all light from light sources and the areas of [light](Reference/Compendium/Spells/light.md) spells are halved. Darkness and shadow magic are enhanced, and light magic is impeded.
