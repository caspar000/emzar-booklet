...
To use one of the NPCs in this section to represent an NPC of a different ancestry, apply the adjustments below for the desired ancestry. These provide the basic features from that ancestry, like [darkvision](Reference/Rules/Abilities/darkvision.md), altered Speed, and unique abilities like a halfling's keen eyes. For other ancestries, you can create similar templates following the same format.
...
Change the [human](human.md "Human Ancestry & Heritage Trait") trait to [dwarf](dwarf.md "Dwarf Ancestry & Heritage Trait").

- Add Dwarven to the NPC's languages.
- Add [darkvision](Reference/Rules/Abilities/darkvision.md).
- Decrease the NPC's Speed by 5 feet. If the NPC already has a reduced Speed due to their armor, consider applying the [Unburdened Iron](unburdened-iron.md) ancestry feat.

#### Elf
<sup>GMG p. 204</sup>

Change the [human](human.md "Human Ancestry & Heritage Trait") trait to [elf](elf.md "Elf Ancestry & Heritage Trait").
...
Change the [human](human.md "Human Ancestry & Heritage Trait") trait to [gnome](gnome.md "Gnome Ancestry & Heritage Trait").
...
Change the [human](human.md "Human Ancestry & Heritage Trait") trait to [goblin](goblin.md "Goblin Ancestry & Heritage Trait").
...
Change the [human](human.md "Human Ancestry & Heritage Trait") trait to [halfling](halfling.md "Halfling Ancestry & Heritage Trait").
