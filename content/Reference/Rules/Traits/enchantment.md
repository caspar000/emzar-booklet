...
Enchantments affect the minds and emotions of other creatures—sometimes to influence and control them, and other times to bolster them to greater heights of courage. Enchantment spells almost always have the [mental](mental.md "Mental Effect Trait") trait, and many have the [emotion](emotion.md "Emotion Effect Trait") trait or the [fear](Reference/Rules/Traits/fear.md "Fear Effect Trait") trait.
